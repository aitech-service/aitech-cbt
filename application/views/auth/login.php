<div class="container pt-4">
    <div class="info-box bg-transparent shadow-none">
        ...
        <a href="https://www.instagram.com/servicelaptop.gresik/" target="blank"><img src="<?php echo base_url('assets/img/aitech.png')?>" width="60" height="60" class="rounded float-right"></a>
    </div>
...
<script type="text/javascript">
    ...
    var img = ["bg-login4.jpg", "bg-login2.jpg", "wall3.jpg"];
